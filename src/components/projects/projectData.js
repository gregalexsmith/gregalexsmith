...
export default [
  {
    ...
    "desc" : "Explore and practice chord progressions on the web",
    "tech" : {
  ...
  },
  {
    ...
    "desc" : "Artist website and blog for local band Tree Museum. Includes splash page, Instagram integration, show feed and contact form.",
    "tech" : {
  ...
  },
  {
    ...
    "desc" : "An animated pomodoro timer build with React, styled components and gsap",
    "tech" : {
